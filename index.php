      ...
      <div class="works-three">
       ...
       <!-- COLUMN 1 · PROJECTS (IMPROVED with icons) -->
        ...
        <div class="work-tile">
          ...
          <div style="margin-bottom:2rem;">
            <h3 style="color:var(--green); font-size:1.1rem; margin-bottom:0.8rem;">
              <i class="fas fa-calendar-alt" style="margin-right:6px;"></i> MinSU Event Scheduler
            </h3>
            <div class="design-showcase">
      ...
      <div class="grid-2col">
        ...
        <div class="card">
          ...
          <p><strong>Email:</strong><br>
            <a href="mailto:hanahmendoza78@gmail.com" style="text-decoration: none; color: inherit;">
              hanahmendoza78@gmail.com
            </a>
          </p>
          ...
          <div style="margin-top:2rem;">
            ...
            <div class="social-icons">
              ...
              <a href="https://mail.google.com/mail/?view=cm&fs=1&to=hanahmendoza78@gmail.com" target="_blank"title="Gmail"><i class="fas fa-envelope"></i></a>            </div>
          </div>
        </div>
